...
embedding_path = '/home/andreashhp/polyglot_data/embeddings2/en/embeddings_pkl.tar.bz2'
...
model = TransformerModel(ntokens, emsize, nhead, nhid, nlayers, embeddings, dropout)
