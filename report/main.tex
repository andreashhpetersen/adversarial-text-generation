...
Training sentence embeddings is difficult when the embedded
size has a fixed size, but further research is necessary.
We achieve promising results, but sentences look very messy.
